...
<section class="heading">
    <h3>shopping cart</h3>
    <p> <a href="meniu.php">home</a> / cart </p>
</section>
...
<section class="shopping-cart">
    ...
    <div class="more-btn">
        <a href="cart-shop.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from cart?');">delete all</a>
    </div>
